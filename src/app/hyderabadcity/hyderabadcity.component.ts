...
@Component({
  selector: 'app-hyderabadcity',
  templateUrl: './hyderabadcity.component.html',
  styleUrls: ['./hyderabadcity.component.css'],
  styles: [
    `
      table {
        width: 100%;
...
export class HyderabadcityComponent implements OnInit {
  public value = [];
  ...
  constructor(public bankHttpService: BankhttpService) {
    console.log('Hyderabad city component constructor is called');
  ...
  ngOnInit() {
    console.log('Hyderabad city component onInit called');
    /*subscribing to the services*/
    this.bankHttpService.getHyderabadBranches()
