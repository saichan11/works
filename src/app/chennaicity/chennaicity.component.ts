...
@Component({
  selector: 'app-chennaicity',
  templateUrl: './chennaicity.component.html',
  styleUrls: ['./chennaicity.component.css'],
  styles: [
    `
      table {
        width: 100%;
...
export class ChennaicityComponent implements OnInit {
  public value = [];
  ...
  constructor(public bankHttpService: BankhttpService) {
    console.log('Chennai city component constructor is called');
